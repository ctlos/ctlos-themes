...
OPTIONS:
  ...
  -i, --icon VARIANT      Specify logo icon on nautilus [default|ctlos|manjaro|ubuntu|fedora|debian|arch|gnome|budgie|popos|gentoo|void|zorin|mxlinux|opensuse] (Default: mountain icon)
